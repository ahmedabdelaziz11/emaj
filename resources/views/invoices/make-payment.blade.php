			...
			<div class="card-body">
				<form action="{{ route('payment') }}" method="post" autocomplete="off">
					...
					<div class="row">
						...
						<div class="form-group col-3">
							<label>حساب الايراد</label>
							<select class="form-control select2 " name="revune_id" required>
					...
					success: function(data) {
						...
						data.forEach( (product) => {
							$("#items_container").append(`
								...
								<td style="padding-top:20px;font-size:17px;font-weight:bold">` + product.quantity +`</td>
								</tr>
							`);
						});
					},
