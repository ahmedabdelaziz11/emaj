                ...
                <div class=" main-content-body-invoice" id="print">
                    <div class="card card-invoice">
                        <div class="card-body">
                            ...
                            <h1 style="text-align: center ; font-weight: bold">العملاء المديونون</h1>
                                ...
                                <table class="table table-invoice border text-md-nowrap mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="font-size: 17px" style="text-align: right;">اسم العميل</th>
                                        ...
                                        @foreach ($clients as $x)
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: right;font-size: 17px;font-weight: bold;border-left: 1px solid rgb(177, 170, 170);">{{ $x->client_name }}</td>  
