    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0" id="form">
                ...
                <form action="Search_invoice_s" method="POST" role="search" autocomplete="off">
                    {{ csrf_field() }}
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="client_id" id="client_picker" required="required">
