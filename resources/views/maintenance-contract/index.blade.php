    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">حذف عقد الصيانة</h6><button aria-label="Close" class="close" data-dismiss="modal"
...
<script>
    ...
    $('#printTable').click(function(){
        document.maintenanceContractsForm.action = "/print-maintenance-table"  
        document.maintenanceContractsForm.submit()
    })
</script>
@endsection