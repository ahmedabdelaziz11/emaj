        ...
        <div class="card mg-b-20" id="tabs-style2">
            <div class="card-body">
                    <form  action="{!! route('days.update',$day->id) !!}" method="post">
                        ...
                        <div class="row">
                            <div class="col-4">
                                ...
                                <input class="form-control fc-datepicker" name="date" placeholder="YYYY-MM-DD"
                                    type="text" value="{{ $day->date }}" required>
                            </div>

                            <div class="col-8">
                                <label>البيان</label>
                                <input class="form-control" name="day_details" value="{{$day->note}}" type="text"  required>
                            </div>
                        </div>
                        <br>


                        <div class="form-group" id="dsTable">
                                        ...
                                        <tr>
                                            <td style="width:280px">
                                                <div style="width:280px" class="form-group">
                                                    ...
                                                    <option value="{{$x->account_id }}"selected>{{$x->account->name}} </option>
                                            ...
                                            <td style="width:250px"><input type="number" step=".01" style="font-size:17px;font-weight:bold" name="debit[]"  value="{{$x->debit}}" onchange='updateTotal();' class=" form-control text-center"></td>
                                            <td style="width:250px"><input type="number" step=".01" style="font-size:17px;font-weight:bold" name="credit[]" value="{{$x->credit}}" onchange='updateTotal2();' class=" form-control text-center"></td>
                                            <td style="width:400px"><input type="text" name="details[]" value="{{$x->note}}"  class=" form-control text-right"></td>
                                            <td style="width:150px">
                                                <div style="width:150px" class="form-group">
                                                    ...
                                                    <option value="{{$x->cost_id ?? 'null'}}" selected>{{$x->cost->name ?? 'لايوجد'}}</option>
                                            ...
                                            <td style="width:10px"><button type="button" class="btn btn-sm btn-danger float-none" onclick="deleteRow(this)" ><i class="fas fa-times"></i></button></td>
                                        </tr>
                                    @endforeach
                                    <input type="hidden" name="js" id="js" value="{{$c}}">
                                </tbody>
                            </table>
                        </div>
                        <div class="row">
                        ...
                        <button type="submit" id="submit" class="btn btn-primary w-100" disabled>تعديل</button>
...
function updateTotal() {
    ...
    var sub = parseFloat(total - list2);
...
function updateTotal2() {
    ...
    var sub = parseFloat(list1 - total);
    document.getElementById("total_sub").value = sub;    
...
<script>
    $(document).ready(function(){
        var items = document.getElementById('js').value;
        var id = document.getElementById('js').value;
        $("#add_day").on('click',function(){
            ...
            $("#product_container").append(`
                ...
                <td style="width:400px"><input type="text" name="details[]"   class=" form-control text-right"></td>
                <td style="width:150px">
                    <div style="width:150px" class="form-group">
                        <select  style="width:150px" class="form-control custom-select select2" name="cost_id[]" required="required">
                        @foreach ($costs as $cost)
                ...
                <td style="width:10px"><button type="button" name="delete1" class="btn btn-sm btn-danger float-none" id="remove_product`+id+`" value="`+id+`" style="width:100%"><i class="fas fa-times" style="width:100%"></i></button></td>
                </tr>
                `);
            }
            $('.custom-select').select2();
