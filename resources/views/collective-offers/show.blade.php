        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">                        
                            <a href="{{ url('/' . $page='collective_offers') }}">العروض المجمعه</a>
                                                                    ...
                                                                    <table class="table table-invoice border text-md-nowrap mb-0">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            @foreach ($invoices as $invoice)
                                                                                @foreach ($invoice->prodcuts as $product)
                                                                                    <?php
                                                                                        $i++;
                                                                                        $total = $product->pivot->product_quantity * $product->pivot->product_selling_price;
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="text-center" style="font-size: 17px;font-weight: bold;border: 1px solid rgb(177, 170, 170);">{{ number_format($product->pivot->product_selling_price,2) }}</td>													                              
                                                                                        <td class="text-center" style="font-size: 17px;font-weight: bold;border: 1px solid rgb(177, 170, 170);">{{ number_format($product->pivot->product_quantity * $product->pivot->product_selling_price,2) }}</td>													                              
                                                                                    </tr>
                                                                                    @php
                                                                                        $discount = (  $invoice->discount / 100 ) * $totalall;
