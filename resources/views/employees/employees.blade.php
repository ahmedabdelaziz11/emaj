            ...
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                        ...
                        <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale"
                            data-toggle="modal" href="#modaldemo8">اضافة موظف</a>
                                ...
                                <tr>
                                    ...
                                    <td>        
                                            ...
                                            <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                data-id="{{ $x->id }}" data-name="{{ $x->name }}" data-role="{{ $x->role }}" data-national_id="{{ $x->national_id }}"
                                                data-address="{{ $x->address }}" data-start_debt="{{ $x->start_debt }}" data-end_date="{{ $x->end_date }}" data-start_date="{{ $x->start_date }}" data-email="{{ $x->email }}" data-s="{{ $x->Salary }}" data-Salary="{{ $x->Salary }}"  data-phone="{{ $x->phone }}" 
                                                data-date_of_birth="{{ $x->date_of_birth }}"  data-toggle="modal"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">اضافة موظف</h6><button aria-label="Close" class="close" data-dismiss="modal"
                ...
                <div class="modal-body">
                    <form action="{{ route('employees.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control fc-datepicker" name="end_date" id="end_date" placeholder="YYYY-MM-DD"
                            type="date" value="">
                        </div>
...
<script>
    $('#exampleModal2').on('show.bs.modal', function(event) {
        ...
        var start_debt         = button.data('start_debt')
        var s        = button.data('s')
        ...
        modal.find('.modal-body #start_debt').val(start_debt);
        modal.find('.modal-body #Salary').val(s);
