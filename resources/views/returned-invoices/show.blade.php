    ...
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">
                <a href="{{ url('/' . $page='returned_invoices') }}"> المبيعات </a>
                                                ...
                                                <div class=" main-content-body-invoice" id="print">
                                                    <div class="card card-invoice">
                                                        <div class="card-body">
                                                            ...
                                                            <h1 style="text-align: center ; font-weight: bold">فاتورة مرتجع مبيعات</h1>
                                                                    ...
                                                                    <table class="table table-invoice  text-md-nowrap mb-0">
                                                                        <tbody class="tx-right">
                                                                            ...
                                                                            <tr class="border border-light tx-right">
                                                                                ...
                                                                                <th class="text-center" style="font-size: 17px;font-weight: bold;" colspan="2">{{ number_format($invoice->value_added ? $invoice->value_added : 0,2) }}</th>
                                                                            </tr>
