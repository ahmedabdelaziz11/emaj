    ...
    <div class="card mg-b-20">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-8">
                    <h6 class="modal-title text-primary" style="padding-top:25px ; float: left; font-size: 35px; "> اجمالى المخزون : {{number_format(\App\Models\spares::select(DB::raw('sum(Purchasing_price * quantity  ) as total'))->value('total')) }}</h6>
                </div>
